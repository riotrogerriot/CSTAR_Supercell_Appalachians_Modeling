...
for i in range( 0, len( sim ) ):
    ...
    filename = '/Users/roger/Library/CloudStorage/OneDrive-UniversityofNorthCarolinaatCharlotte/CSTAR/Steady_State_Sims/Simulations/real_terrain/Stats_Spreadsheets/' + sim[i] + '_output_stats.csv'
...
# Save figure
fig.savefig(
            fname = '{}_rltrn_stats_plot.jpeg'.format( composite ),
            dpi = 300,
            bbox_inches = "tight"
           )

...
for i in range( 0, len( sim ) ):
    ...
    os_type = 1
    if( os_type == 0 ):
        wdir = '/Users/roger/Library/CloudStorage/OneDrive-UniversityofNorthCarolinaatCharlotte/CSTAR_Modeling_Project/Simulations/Steady_State_Sims/id_terrain/Stats_Spreadsheet/'
    else:
    ...
    ax_H.legend( handles = [lineH1, lineH2], prop = {'size': 14}, loc = 'lower left', facecolor = 'lightgrey' )
    ax_H.grid()

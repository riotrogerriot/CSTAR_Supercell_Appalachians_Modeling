...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  6 20:06:12 2022
...
#     sim = [ 'cs_rltrn_all', 'cs_rltrn_no_out', 'cs_rltrn_out' ]
...
#     sim = [ 'nc_rltrn_all', 'nc_rltrn_no_out' ]
...
#------------------------------------------------------------------------------
    ...
    linear = [ 96, 0 ]                              # Upscale Growth Index
#------------------------------------------------------------------------------
...
for i in range( 0, len( sim ) ):
    ...
    # Construct filename string (!!! Requires appropriate directory containing RLTRN CSVs !!!)
    if( os_type == 0 ):
    ...
    # Panel A Line Plot
    ax_A.plot( time[ 0:dis_end[i] ], uh_area[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '-',label = sim[i].upper() )
    ...
    # Same for Panel B
    ax_B.plot( time[ 0:dis_end[i] ], meso_depth[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '-', label = sim[i].upper() )
    ...
    # Same for Panel C
    ax_C.plot( time[ 0:dis_end[i] ], zA3km[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '--', label = sim[i].upper() + ' \u03b6-3km' )
    ax_C.plot( time[ 0:dis_end[i] ], zA5km[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '-', label = sim[i].upper() + ' \u03b6-5km' )
    ...
    # Same for Panel D
    ax_D2.plot( time[ 0:dis_end[i] ], mlcin[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '--', label = sim[i].upper() + ' MLCIN' )
    ax_D.plot( time[ 0:dis_end[i] ], mlcape[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '-', label = sim[i].upper() + ' MLCAPE' )
    ...
    ax_E.plot( time[ 0:dis_end[i] ], shear3km[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '--', label = sim[i].upper() + ' 0-3km Shear' )
    ax_E.plot( time[ 0:dis_end[i] ], shear6km[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '-', label = sim[i].upper() + ' 0-6km Shear' )
    ...
    ax_E.legend( handles = [ lineE2, lineE3 ], prop = {'size': 14}, facecolor = 'lightgrey' )
    ax_E.grid()
    ...
    ax_F.plot( time[ 0:dis_end[i] ], srh1km[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '--', label = sim[i].upper() + ' 0-1km SRH' )
    ax_F.plot( time[ 0:dis_end[i] ], srh3km[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '-', label = sim[i].upper() + ' 0-3km SRH' )
    ...
    ax_F.legend( handles = [ lineF2, lineF3 ], prop = {'size': 14}, facecolor = 'lightgrey' )
    ax_F.grid()
    ...
    # Same for panel H
    ax_H2.plot( time[ 0:dis_end[i] ], cp_intensity[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '--', label = sim[i].upper() + '$\u03b8_{pert}$ Min ' )
    ax_H.plot( time[ 0:dis_end[i] ], cp_area[ 0:dis_end[i] ], color = color[i], linewidth = lwidth, linestyle = '-', label = sim[i].upper() + ' $\u03b8_{pert}$ Area' )
